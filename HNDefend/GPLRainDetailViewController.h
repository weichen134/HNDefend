...
@interface GPLRainDetailViewController : GPLParentViewController<UIWebViewDelegate,UIActionSheetDelegate>
//top bar
...
//view
@property(nonatomic,weak) IBOutlet UIView *waterDetailV;
//params
...
@property(nonatomic,strong) GPLWaterListInfo *mySum;
